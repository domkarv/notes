...
gsap
  .timeline()
  .set(".ring", { rotationY: 145, cursor: "pointer" }) //set initial rotationY so the parallax jump happens off screen
  .set(".img", {
...
function getBgPos(i) {
  ...
  return (
    ...
    (gsap.utils.wrap(
      0,
      360,
      gsap.getProperty(".ring", "rotationY") - 180 - i * 72
    ) /
      360) *
      500 +
    "px 0px"
