...
app.get("/blogs/:blogTitle", (req, res) => {
  ...
  // const requestedTitle = lodash.lowerCase(req.params.blogTitle);
  blogs.forEach((blog) => {
    // const storedTitle = lodash.lowerCase(blog.title);
    if (
      lodash.lowerCase(blog.title) === lodash.lowerCase(req.params.blogTitle)
    ) {
...
app.listen(80, () => {
  console.log("Server started at http://127.0.0.1 / http://localhost");
});
